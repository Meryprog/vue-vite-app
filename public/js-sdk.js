...
(function (global, factory) {
  ...
  function onScreenRecord() {
      MacleJSBridge.onBasicEvent(APINames.Native.ON_SCREEN_RECORD_STATE_CHANGE, function (params) {
  ...
  */
  ...
  function setStorageSync(key, data) {
      ...
      return MacleJSBridge.invokeSync(APINames.Native.SET_STORAGE_SYNC, { key, data });
  }

  const apiName$1 = 'onScreenRecordingStateChanged';
  // 监听用户录屏事件
